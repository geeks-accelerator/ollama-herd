...
MODEL_CATALOG: list[ModelSpec] = [
    ...
    ModelSpec(
        ...
        notes="Tiny coding specialist. Deprecation-warned by Ollama 0.32+; prefer qwen3-coder",
    ),
    ...
    ModelSpec(
        ollama_name="deepseek-v3:7b",
        display_name="DeepSeek V3 7B",
        family="deepseek-v3",
        params_b=7.0,
        ram_gb=5.5,
        size_class=ModelSize.MEDIUM,
        category=ModelCategory.GENERAL,
        secondary_categories=[ModelCategory.CODING],
        context_length=65536,
        benchmarks=ModelBenchmarks(mmlu=74.0, humaneval=73.0),
        notes="Dense general-purpose, strong coding",
    ),
    ModelSpec(
    ...
    ModelSpec(
        ...
        notes="Strong HumanEval. Deprecation-warned by Ollama 0.32+; prefer qwen3-coder:30b",
    ),
    ModelSpec(
        ...
        notes="Great 14B coder. Deprecation-warned by Ollama 0.32+; prefer qwen3-coder:30b",
    ),
    ModelSpec(
    ...
    ModelSpec(
        ...
        display_name="Qwen 3 Coder 30B-A3B (MoE)",
        family="qwen3-coder",
        params_b=30.0,
        active_params_b=3.0,
        ram_gb=19.0,
        ...
        category=ModelCategory.CODING,
        context_length=262144,
        benchmarks=ModelBenchmarks(mmlu=76.0, humaneval=90.0),
        notes="Agentic coding specialist, 256K context — the local Claude Code workhorse",
    ),
    ModelSpec(
    ...
    ModelSpec(
        ollama_name="deepseek-v3:32b",
        display_name="DeepSeek V3 32B",
        family="deepseek-v3",
        params_b=32.0,
        ram_gb=22.0,
        size_class=ModelSize.LARGE,
        ...
        context_length=65536,
        benchmarks=ModelBenchmarks(mmlu=83.0, humaneval=82.0),
        notes="Dense general-purpose, competitive with R1 on coding",
    ),
    ModelSpec(
    ...
    # ── Gemma 4 (Ollama 0.30.3–0.31.1) — multimodal successor to Gemma 3 ──
    # All variants are vision-capable, so they're valid targets for the
    # Anthropic auto-router's image path (is_vision_model → rank_candidates).
    # Benchmarks are conservative successor-of-gemma3 estimates.
    ModelSpec(
        ollama_name="gemma4:e4b",
        display_name="Gemma 4 E4B (efficient)",
        family="gemma4",
        params_b=4.0,
        ram_gb=4.0,
        size_class=ModelSize.SMALL,
        category=ModelCategory.VISION,
        secondary_categories=[ModelCategory.GENERAL, ModelCategory.CODING],
        context_length=131072,
        benchmarks=ModelBenchmarks(mmlu=72.0, humaneval=68.0),
        notes="Efficient multimodal, runs on laptops; QAT tags (e4b-it-qat) share this family",
    ),
    ModelSpec(
        ...
        secondary_categories=[ModelCategory.GENERAL, ModelCategory.CODING],
        context_length=131072,
        benchmarks=ModelBenchmarks(mmlu=79.0, humaneval=74.0),
        notes="High-performance multimodal that runs on laptops, strong reasoning",
    ),
    ModelSpec(
        ollama_name="gemma4:26b-a4b",
        ...
        secondary_categories=[ModelCategory.GENERAL, ModelCategory.CODING],
        context_length=131072,
        benchmarks=ModelBenchmarks(mmlu=82.0, humaneval=78.0),
        notes="MoE multimodal: 26B total, 4B active — strong quality per GB",
    ),
    ModelSpec(
        ...
        secondary_categories=[ModelCategory.GENERAL, ModelCategory.CREATIVE],
        context_length=131072,
        benchmarks=ModelBenchmarks(mmlu=83.0, humaneval=78.0),
        notes="Largest Gemma 4; best vision + creative writing in the family",
    ),
    # ── Other models added in Ollama 0.30.4–0.30.9 ──
    ModelSpec(
        ollama_name="nemotron-3-ultra",
        ...
        secondary_categories=[ModelCategory.GENERAL],
        context_length=131072,
        benchmarks=ModelBenchmarks(mmlu=86.0, humaneval=82.0),
        notes="Built for high-throughput reasoning + long-running agent workflows; very large",
    ),
    ModelSpec(
        ollama_name="command-a",
        ...
        secondary_categories=[ModelCategory.CODING],
        context_length=262144,
        benchmarks=ModelBenchmarks(mmlu=83.0, humaneval=76.0),
        notes="Cohere2Moe architecture; strong general + tool use, 256K context",
    ),
    ModelSpec(
        ...
        notes="Deprecation-warned by Ollama 0.32+; prefer qwen3-coder:30b for new deployments",
    ),
    ModelSpec(
    ...
    ModelSpec(
        ...
        context_length=131072,
        benchmarks=ModelBenchmarks(mmlu=87.1, humaneval=89.0),
        notes="MoE flagship, 37B active params, frontier-class general model",
    ),
    ModelSpec(
